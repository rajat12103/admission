...
<div class="card">
    <table>
        <tr>
            <td>CSE SEATS OCCUPIED={{$countcse}}</td>
            <td> IT SEATS OCCUPIED={{$countit}}</td>
            <td>AU SEATS OCCUPIED={{$countau}}</td>
            <td>ME SEATS OCCUPIED={{$countme}}</td>
            <td> EE SEATS OCCUPIED={{$countee}}</td>
            <td>EC SEATS OCCUPIED={{$countec}}</td>
        </tr>
                            ...
                            <div class="card-body">
                             ...
                             <!-- <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table-export" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 108px;">Attendance</th> -->
                                    ...
                                    <tbody>   
                                    <form class="form-stacked" action="{{url('/allotbranch101')}}" method="post" enctype="multipart/form-data">
                                        {{csrf_field()}}
